      ...
      <div className="px-4 pt-6">
        <div className="mb-6 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-paypal-dark">Shopping Cart Buttons</h1>
              <p className="text-xs font-semibold text-muted-foreground">Product catalog + embeds.</p>
            </div>
          </div>
        ...
        <div className="paypal-surface rounded-[2rem] bg-white p-6 shadow-sm border border-paypal-blue/5">
          <div className="flex items-start gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-paypal-blue/10">
              <ShoppingCart className="h-6 w-6 text-paypal-blue" />
            </div>
            <div className="min-w-0">
              <p className="text-base font-black tracking-tight text-foreground">Sell multiple items</p>
              <p className="mt-1 text-sm text-muted-foreground">
                Add products to your catalog, then generate widget/iframe embeds that behave like cart buttons.
              </p>
            </div>
          </div>
...
export default ButtonsCartPage;
