-- Simple Fix for Merchant Payment Link Function
-- This script drops and recreates the function with correct parameters

-- Step 1: Drop function by name only (no signature)
...
BEGIN
  ...
  RAISE NOTICE 'Function dropped and recreated with all frontend parameters';
  RAISE NOTICE 'Payment links creation should now work correctly';
END $$;
