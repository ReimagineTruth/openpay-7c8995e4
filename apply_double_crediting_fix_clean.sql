...
-- Fix the main virtual card payment function (primary cause of double crediting)
...
-- Ensure public payment functions also credit merchant wallet only
...
-- Create verification function to confirm fix
